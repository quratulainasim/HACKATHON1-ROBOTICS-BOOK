export declare function parseJWT(jwt: string): [header: object, payload: object, signature: Uint8Array];
export declare function encodeJWT(header: object, payload: object, signature: Uint8Array): string;
export declare function createJWTSignatureMessage(header: object, payload: object): Uint8Array;
...
export declare class JWSHeaderParameters {
    private target;
    constructor(target: object);
